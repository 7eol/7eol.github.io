    ...
    <style>
        ...
        * {
        ...
        .button {
            ...
            justify-content: center;
            align-items: center;
            filter: drop-shadow(0 0 0px lightgray); /* Initial state, no glow */
        }

        .button svg {
            width: 35px;
            height: 35px;
            fill: lightgray; /* Light gray color for buttons */
        }

        .button:hover {
            transform: scale(1.1);
            filter: drop-shadow(0 0 10px lightgray); /* Glow effect */
        }
        ...
        .volume-button:hover {
            width: 60px; /* Extend when hovered */
        }
...
<body>
                ...
                <div class="button">
                    <a target="_blank" href="https://roblox.com/users/938926711">
                        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0.16 0 23.68 24">
                            <path fill="currentColor" d="M5.164 0L.16 18.928L18.836 24L23.84 5.072Zm8.747 15.354l-5.219-1.417l1.399-5.157l5.216 1.417l-1.399 5.157z"></path>
                        </svg>
                    </a>
                </div>
            </div>
    ...
    <script>
        // JavaScript for handling the overlay and audio controls
        ...
        overlayMessage.addEventListener('click', () => {
            ...
            // Play video and audio after click
